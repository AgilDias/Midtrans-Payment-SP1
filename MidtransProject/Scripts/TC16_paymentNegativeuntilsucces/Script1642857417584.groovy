...
Diskon = WebUI.getAttribute(findTestObject('Payment/select_promo10'), '')

for (def index : (1..3)) {
    WebUI.setText(findTestObject('Payment/input_cardnumberCC'), findTestData('PaymentNegative').getValue(2, index))

    WebUI.setText(findTestObject('Payment/input_expirydateCC'), findTestData('PaymentNegative').getValue(3, index))

    WebUI.setText(findTestObject('Payment/input_cvvCC'), findTestData('PaymentNegative').getValue(4, index))
...
WebUI.setText(findTestObject('Payment/input_OTPbank'), '112233')
