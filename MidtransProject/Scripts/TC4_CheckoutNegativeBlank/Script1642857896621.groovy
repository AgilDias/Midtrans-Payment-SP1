...
WebUI.setText(findTestObject('Checkout/txt_name'), '  ')

WebUI.setText(findTestObject('Checkout/txt_email'), '  ')

WebUI.setText(findTestObject('Checkout/phone_number'), '  ')

WebUI.setText(findTestObject('Checkout/txt_city'), '   ')

WebUI.setText(findTestObject('Checkout/txt_addres'), '  ')

WebUI.setText(findTestObject('Checkout/postal_code'), '  ')

WebUI.click(findTestObject('Button/button_checkout'))

WebUI.verifyElementPresent(findTestObject('Checkout/verify_sorry'), 0)
